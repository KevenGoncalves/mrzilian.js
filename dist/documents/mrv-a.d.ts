export class MRVADocument {
     ...
     */
    constructor(docType: string, country: string, documentNumber: string, sex: string, givenNames: string, surname: string, birthDate: string, expirationDate: string, nationality: string, optionalData1: string);
    /**
     * @public
     * @type {string}
     * @description two characters must be V first letter and second any
     * @example V
     */
...
//# sourceMappingURL=mrv-a.d.ts.map